...
pd1 <- as_persistence(ripserr::vietoris_rips(pt1, max_dim = 2L, threshold = 3))
pd2 <- as_persistence(ripserr::vietoris_rips(pt2, max_dim = 2L, threshold = 3))
...
pd <- as_persistence(ripserr::vietoris_rips(pt, max_dim = 2, threshold = 3))
...
for (i in seq(100)) {
  ...
  pdi <- as_persistence(ripserr::vietoris_rips(pti, max_dim = 2, threshold = 3))
