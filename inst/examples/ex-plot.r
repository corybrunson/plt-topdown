...
# palette name
plot(landscape(pd, degree = 0L, min_x = 0, max_x = 1.5, dx = 0.01),
     palette = "Cork", lwd = 1)
# palette function name
plot(landscape(pd, degree = 1L, min_x = 0, max_x = 1.5, dx = 0.01),
     palette = "topo.colors", lwd = 1, rev = TRUE)
# custom color ramp
plot(landscape(pd, degree = 2L, min_x = 0, max_x = 1.5, dx = 0.01),
